...
//   ngOnInit(): void {
//     this.sellerService.getSellerLists().subscribe(data =>{this.seller=data});
//   }
...
export class SellerListComponent implements OnInit {
  ...
  getList() {
    ...
    this.sellerService.getListOfStores(this.params)
      .subscribe(res => {
  ...
  setSettings() {
    ...
    this.settings = {
      ...
      columns: {
        ...
        name: {
          title: this.translate.instant('COMMON.SELLER_NAME'),
          type: 'string',
        },
        email: {
      ...
      case 'remove':
        ...
        if (code === sellerCode) {
          ...
          .onClose.subscribe(res => {
              if (res) {
                this.sellerService.deleteStore(event.data.code)
                  .subscribe(data => {
